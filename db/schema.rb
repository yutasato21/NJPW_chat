...
ActiveRecord::Schema.define(version: 2022_01_20_031725) do
  ...
  create_table "room_matches", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "room_id", null: false
    t.bigint "match_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["match_id"], name: "index_room_matches_on_match_id"
    t.index ["room_id"], name: "index_room_matches_on_room_id"
  end
  ...
  add_foreign_key "room_matches", "matches"
  add_foreign_key "room_matches", "rooms"
end
